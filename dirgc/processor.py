...
def process_excel_rows(
    ...
    SAVE_EVERY = 10  # checkpoint tiap 10 row
    ...
    try:
        ...
        # Ctrl+C: simpan lalu hentikan
        write_run_log(run_log_rows, run_log_path)
        raise  # biar program benar-benar stop, tapi data sudah tersimpan [web:63]

    finally:
        # Save terakhir apapun yang terjadi
        write_run_log(run_log_rows, run_log_path)
        log_info("Run log saved.", path=str(run_log_path))
